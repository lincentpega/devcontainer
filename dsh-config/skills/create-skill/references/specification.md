...
Source: https://agentskills.io/specification (fetched and bundled here so no web
fetch is needed). Pi implements this standard; most violations warn but still
load.
